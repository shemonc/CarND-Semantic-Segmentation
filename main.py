...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    :param get_batches_fn: Function to get batches of training data.  Call
                           using get_batches_fn(batch_size)
    ...
    for epoch in range(epochs):
        ...
        for image, label in get_batches_fn(batch_size):
            ...
            loss_per_epoch.append("{:.3}".format(loss))
        print("Epoch {} Loss {} \n".format(epoch+1, loss_per_epoch))
